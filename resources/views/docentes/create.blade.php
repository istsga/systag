                                ...
                                <div class="card shadow-sm m-3">
                                    <div class="row m-4">
                                        ...
                                        <div class="card p-3 col-lg-5">
                                            ...
                                            <div id="Vnombre" class="form-group " style="display:none" >
                                            ...
                                            <div id="Vapellido" class="form-group " style="display:none">
                                        ...
                                        <div class="card col-lg-6 p-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-12">
                                                    <div class="card p-3">
                                                        <label for="estado" class="col-form-label font-weight-bold text-muted">ESTADO DEL DOCENTE
                                                            <span class="text-primary">*</span>
                                                        </label>
                                                        <div class="input-group">
                                        ...
                                        <div class="row m-2">
                                            <div class="form-group col-lg-6" >
                                                <label for="email" class="col-form-label font-weight-bold text-muted">E-Mail
                                                    <span class="text-primary">*</span></label>
                                                <div class="input-group" >
                                                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" onkeyup="vEmail()"
                                            ...
                                            <div class="form-group col-lg-3">
                                                ...
                                                <div class="input-group">
                                                    <input id="telefono_fijo" type="text" class="form-control @error('telefono_fijo') is-invalid @enderror" onkeyup="vFijo()"
                                            ...
                                            <div class="form-group col-lg-3">
                                                <label for="telefono_movil" class="col-form-label font-weight-bold text-muted">Teléfono celular
                                                    <span class="text-primary">*</span></label>
                                                <div class="input-group" >
                                                    <input id="telefono_movil" type="text" class="form-control @error('telefono_movil') is-invalid @enderror" onkeyup="vCelular()"
...
<script src="{{asset('js/validateDocente.js')}}"></script>
@endpush
