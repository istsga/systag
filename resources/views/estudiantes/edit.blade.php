        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="card shadow-lg">
                    ...
                    <div class="card-body">
                        <form id="regForm" method="POST"  action="{{ route('estudiantes.update', $estudiante)}} " enctype="multipart/form-data">
                            @csrf @method('PUT')
                            <div class="tab ">
  ...
  function cambia_cantones1(select){
        ...
        if (provincia != 0) {
            ...
            for(i=0;i<num_cantones;i++){
                ...
                direccion_cantone_id.options[i].selected= (direccion_cantone_id.options[i].value == canton) ? true : false;
