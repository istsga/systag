                ...
                <div class="card shadow-lg">
                    ...
                    <div class="card-body">
                        <form id="regForm" method="POST"  action="{{ route('estudiantes.store')}} " enctype="multipart/form-data">
                            @csrf
                            <div class="tab ">
                                <div class="col-lg-12 d-flex justify-content-center" style="margin-bottom: -10px; margin-top: -10px">
                            ...
                            <div class="tab">
                                <div class="col-lg-12 d-flex justify-content-center "style="margin-bottom: -10px; margin-top: -10px">
                                    <h5 class="text-dark font-weight-bold"> <em>INFORMACIÓN BÁSICA</em> </h5>
                                </div>
                            ...
                            <div class="tab">
                                    <div class="col-lg-12 d-flex justify-content-center "style="margin-bottom: -10px; margin-top: -10px">
                                        <h5 class="text-dark font-weight-bold"> <em>INFORMACIÓN FAMILIAR</em> </h5>
                                    </div>
                                    <hr class="bg-dark" style=" border-top: dotted 1px">
                                    <div class="row">
                                        <div class="form-group col-lg-4">
                            ...
                            <div class="tab">
                                    <div class="col-lg-12 d-flex justify-content-center "style="margin-bottom: -10px; margin-top: -10px">
                                        <h5 class="text-dark font-weight-bold"> <em>INFORMACIÓN DE CONTACTO</em> </h5>
                                    </div>
                                    <hr class="bg-dark" style=" border-top: dotted 1px">
                                    <div class="row">
                                        <div class="form-group col-lg-4">
                                        ...
                                        <div class="form-group col-lg-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                name="telefono_movil" value="{{old('telefono_movil')}}" placeholder="Teléfono celular" >
                                                <div class="input-group-prepend "><span class=" input-group-text">
                                        ...
                                        <div class="form-group col-lg-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                name="telefono_parentesco" value="{{old('telefono_parentesco')}}" placeholder="Número de contacto" >
                                                <div class="input-group-prepend "><span class=" input-group-text">
                                                    <i class=" text-primary fas fa-phone-square"></i></span></div>
                            ...
                            <div class="tab">
                                    <div class="col-lg-12 d-flex justify-content-center "style="margin-bottom: -10px; margin-top: -10px">
                                        <h5 class="text-dark font-weight-bold"> <em>INFORMACIÓN ACADÉMICA</em> </h5>
                                    </div>
                                    <hr class="bg-dark" style=" border-top: dotted 1px">
                                    <div class="row">
                                        <div class="form-group col-lg-6">
