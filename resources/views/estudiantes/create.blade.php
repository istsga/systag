                                    ...
                                    <div class="card shadow-sm m-3">
                                        <div class="row m-4">
                                            <div class="card col-lg-6 m-3">
                                                ...
                                                <div class="form-group" id="Vnombre" style="display:none" >
                                                ...
                                                <div class="form-group" id="Vapellido"  style="display:none" >
                                                ...
                                                <div class="row ">
                                                    <div class="form-group col-lg-6">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            name="fecha_nacimiento"  value="{{old('fecha_nacimiento')}}" placeholder="Fecha de Nacimiento" >
                                                            <div class="input-group-prepend "><span class=" input-group-text">
                                            ...
                                            <div class="card col-lg-5 m-3">
                                                ...
                                                <div class="row " id="canton_provincia" style="display:none">
                                                    <div class="form-group col-lg-6">
                                                ...
                                                <div class="form-group " id="lugar_nacimiento" style="display: none">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        name="lugar_nacimiento" value="{{old('lugar_nacimiento')}}" placeholder="País , ciudad..." >
                                                        <div class="input-group-prepend "><span class=" input-group-text">
                                    ...
                                    <div class="card shadow-sm m-3 p-3">
                                        <div class="row  m-3">
                                            <div class="card col-lg-3  mr-5">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        name="ocupacion" value="{{old('ocupacion')}}" placeholder="Ocupación" >
                                                        <div class="input-group-prepend "><span class=" input-group-text">
                                                            <i class=" text-primary fas fa-user-alt"></i></span></div>
                                            ...
                                            <div class="card col-lg-4 mr-5 ml-2 ">
                                                ...
                                                <div class="row " id="InfoDiscapacidad" style="display:none" >
                                            ...
                                            <div class="card col-lg-4 ml-3">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        name="miembro_hogar"  value="{{old('miembro_hogar')}}" placeholder="Miembros del Hogar" >
                                                        <div class="input-group-prepend "><span class=" input-group-text">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        name="ingreso_ec"  value="{{old('ingreso_ec')}}" placeholder="Ingreso Económico" >
                                                        <div class="input-group-prepend "><span class=" input-group-text">
                                            ...
                                            <div class="row p-3">
                                                <div class="form-group col-lg-4">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        name="nombre_padre" value="{{old('nombre_padre')}}" placeholder="Nombres y apellidos del padre" >
                                                        <div class="input-group-prepend "><span class=" input-group-text">
                                                            <i class=" text-primary fas fa-user"></i></span></div>
                                                ...
                                                <div class="form-group col-lg-4">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        name="ocupacion_padre"  value="{{old('ocupacion_padre')}}" placeholder="Ocupación" >
                                                        <div class="input-group-prepend "><span class=" input-group-text">
                                                            <i class=" text-primary fas fa-user"></i></span></div>
                                                ...
                                                <div class="form-group col-lg-4">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        name="nombre_madre"  value="{{old('nombre_madre')}}" placeholder="Nombres y apellidos de la madre" >
                                                        <div class="input-group-prepend "><span class=" input-group-text">
                                                ...
                                                <div class="form-group col-lg-4">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        name="ocupacion_madre" value="{{old('ocupacion_madre')}}" placeholder="Ocupación" >
                                                        <div class="input-group-prepend "><span class=" input-group-text">
                                                            <i class=" text-primary fas fa-female"></i></span></div>
                                            ...
                                            <div class="card col-lg-4 mr-5 ml-2">
                                                ...
                                                <div class="form-group ">
                                                    <label for="email" class="col-form-label font-weight-bold text-muted">E-mail
                                                        <span class="text-primary">*</span></label>
                                                    <div class="input-group">
                                                        <input type="email" class="form-control @error('email') is-invalid @enderror" onkeyup="vEmail()"
                                                    ...
                                                    <em id="ms-email" class="text-danger small" > </em>
                                                </div>

                                                <div class="form-group ">
                                                    <label for="telefono_fijo" class="col-form-label font-weight-bold text-muted">Teléfono fijo</label>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control @error('telefono_fijo') is-invalid @enderror" onkeyup="vFijo()"
                                                    ...
                                                    <em id="ms-fijo" class="text-danger small" > </em>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="telefono_movil" class="col-form-label font-weight-bold text-muted">Teléfono celular
                                                        <span class="text-primary">*</span></label>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control @error('telefono_movil') is-invalid @enderror" onkeyup="vCelular()"
                                                    ...
                                                    <em id="ms-celular" class="text-danger small" > </em>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card col-lg-4 ml-3 ">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        name="nombre_parentesco" value="{{old('nombre_parentesco')}}" placeholder="Nombre de un familiar cercano " >
                                                        <div class="input-group-prepend "><span class=" input-group-text">
                                                            <i class=" text-primary fas fa-user"></i></span></div>
                                                ...
                                                <div class="form-group ">
                                                    <label for="telefono_parentesco" class="col-form-label font-weight-bold text-muted">Número de contacto
                                                        <span class="text-primary">*</span></label>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control @error('telefono_parentesco') is-invalid @enderror" onkeyup="vContacto()"
                                                    ...
                                                    <em id="ms-contacto" class="text-danger small" > </em>
                                                </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        name="parentesco"  value="{{old('parentesco')}}" placeholder="Parentesco" >
                                                        <div class="input-group-prepend "><span class=" input-group-text">
                                                            <i class=" text-primary fas fa-user"></i></span></div>
                                                ...
                                                <div class="card  col-lg-7 ">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            name="institucion_origen"  value="{{old('institucion_origen')}}" placeholder="Institución Educativa" >
                                                            <div class="input-group-prepend "><span class=" input-group-text">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            name="titulo_bachillerato"  value="{{old('titulo_bachillerato')}}" placeholder="Título de bachillerato" >
                                                            <div class="input-group-prepend "><span class=" input-group-text">
...
<script src="{{asset('js/validatEstudiante.js')}}"></script>
@endpush
