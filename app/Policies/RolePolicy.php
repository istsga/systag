...
class RolePolicy
{
   ...
   /**
    ...
    {
       // No permite eliminar Rol Administrador
        if($role->id === 1)
        {
            throw new \Illuminate\Auth\Access\AuthorizationException('No se puede eliminar el rol Administrador.');
           //return Response::deny('No se puede eliminar el rol Administrador.', $user->role );
        }
